...
public class JungSo extends JPanel {
	
	private JFrame mf;
	private JPanel js;
	private Player p;
	
	public JungSo(JFrame mf, Player p) {
		
		this.mf = mf;
		js = this;
		this.p = p;
		
		System.out.println("중소로 들어온 빡빡 : " + p.toString());
		...
		JLabel text1 = new JLabel("당신은 이미 중소기업에 취업했습니다.");
		text1.setSize(1000,120);
		text1.setLocation(97,87);
		text1.setFont(new Font("맑은 고딕", Font.BOLD, 50));
		text1.setHorizontalAlignment(JLabel.CENTER);
		text1.setForeground(new Color(240,247,247));
		this.add(text1);
		
		JLabel text2 = new JLabel("현재의 나를 버리고 희망을 찾기위해");
		text2.setSize(1000,120);
		text2.setLocation(97,247);
		text2.setFont(new Font("맑은 고딕", Font.BOLD, 50));
		text2.setHorizontalAlignment(JLabel.CENTER);
		text2.setForeground(new Color(240,247,247));
		this.add(text2);
		
		JLabel text3 = new JLabel("퇴사하고 다시 KH에 입소 하시겠습니까?");
		text3.setSize(1000,120);
		text3.setLocation(97,407);
		text3.setFont(new Font("맑은 고딕", Font.BOLD, 50));
		...
		text4.setFont(new Font("맑은 고딕", Font.BOLD, 50));
