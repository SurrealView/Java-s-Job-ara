...
public class HomeEnd2 extends JPanel {
	
	private JFrame mf;
	private JPanel he1;
	private Player p;
	
	public HomeEnd2(JFrame mf, Player p) {
		...
		txtArea.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				ChangePanel.replacePanel(mf, he1, new HomeEnd3(mf, p));		
			}
		...
		JLabel text1 = new JLabel("??? : ºýºý¾¾! 9½ÃÀÎµ¥ ¾îµð¿¡¿ä!!! :<");
