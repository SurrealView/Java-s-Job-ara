...
public class HomeEnd1 extends JPanel {

	private JFrame mf;
	private JPanel he1;
	private Player p;
	
	public HomeEnd1(JFrame mf, Player p) {
		...
		txtArea.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				ChangePanel.replacePanel(mf, he1, new HomeEnd2(mf, p));		
			}
		...
		JLabel text1 = new JLabel("ÈåÀ½..... Àß Àä´Ù...");
		...
		JLabel text2 = new JLabel("ÀÌ »óÄèÇÑ ±âºÐ..... :D");
