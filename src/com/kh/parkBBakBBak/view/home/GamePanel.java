...
//				System.out.println("result : " + result);
				if(result == true) {
					...
					checkAnswer.addActionListener(new ActionListener() {
						...
						@Override
						public void actionPerformed(ActionEvent e) {
							JOptionPane.showMessageDialog(mf, "Á¤´äÀÔ´Ï´Ù! \nÄíÆùÀ» ÇÏ³ª µå¸³´Ï´Ù.", "Á¤´ä", JOptionPane.PLAIN_MESSAGE);
					...
					checkAnswer.addActionListener(new ActionListener() {
						...
						@Override
						public void actionPerformed(ActionEvent e) {
							JOptionPane.showMessageDialog(mf, "Æ²·È½À´Ï´Ù...  :(", "¿À´ä", JOptionPane.PLAIN_MESSAGE);
							ChangePanel.replacePanel(mf, gp, new HomePanel(mf, p)); 
						}
					});
//					System.out.println(p.getCouponQTY());
